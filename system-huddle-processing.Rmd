...
# write.csv(hh_data_comp_raw, paste0(path,"hh_data_comp_raw.csv"), row.names = F)
hh_data_comp_raw_pt_entry <<- read_excel("pt_hand_hygiene_comp.xlsx")
# write.csv(hh_data_comp_raw_pt_entry, paste0(path,"hh_data_comp_raw.csv"), row.names = F)

require(openxlsx)
write.xlsx(hh_data_comp_raw_pt_entry, paste0(path,"hh_data_comp_raw.xlsx"))
```
